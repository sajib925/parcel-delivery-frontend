            ...
            <PopoverTrigger asChild>
              ...
              >
                ...
                >
                  ...
                  <path
                    d="M4 12H20"
                    className="origin-center translate-y-1.75 transition-all duration-300 ease-[cubic-bezier(.5,.85,.25,1.1)] group-aria-expanded:translate-y-0 group-aria-expanded:rotate-315"
                  />
                </svg>
              </Button>
            </PopoverTrigger>
